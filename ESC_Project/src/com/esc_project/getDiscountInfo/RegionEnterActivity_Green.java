...
public class RegionEnterActivity_Green extends MainActivity {
	/** Called when the activity is first created. */
	
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_region_green);
		...
		alert.setMessage("TEST메세지 : " + Enter
				+ System.getProperty("line.separator") + "Green Region!!");
		alert.show();
	}
